...
${RED}-${END} ${GREEN}Este sistema é parte do${END} ${RED}Projeto Yui${END}${GREEN}, caso você utilize externamente, precisa inserir a licença${END} ${RED}[MIT]${END} ${GREEN}do Projeto junto a seu sistema com esse arquivo, ou ao menos definir o nome de copyright.${END}
