...
2. - [NodeJS](https://nodejs.org) - Interface de programação da Yui, use a LTS e não esqueça de ativar a instalação da [Build Tools](https://github.com/KillovSky/yui/issues/538).  
